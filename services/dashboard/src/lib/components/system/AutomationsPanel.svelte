<script lang="ts">
  /*
    Panel de automatización: procesos activos agrupados por frecuencia más el
    calendario de jobs. Vivía en /automations, que era una tercera vista del
    mismo store `systemAgenda` que /system ya leía. Ahora es un card-tab de
