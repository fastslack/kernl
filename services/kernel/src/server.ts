...
// Lives in the SDK so defineTool applies the same coercion on the agent-loop
// path, which calls handlers without going through this dispatch.
export { coerceCommonZodIssues } from "./sdk/tool-builder.js";
import { coerceCommonZodIssues } from "./sdk/tool-builder.js";
