...
export function commsTools(service: CommsService): ToolDefinition[] {
  return [
    ...
    defineTool({
      ...
      handler: async ({ comm_id, file_path }) => {
    ...
    defineTool({
      ...
      handler: async ({ query, max_results, account_id }) => {
        try {
    ...
    defineTool({
      ...
      handler: async ({ gmail_message_id, account_id }) => {
        try {
    ...
    defineTool({
      ...
      handler: async ({ comm_id, body, include_quote, cc, reply_all }) => {
        try {
    ...
    defineTool({
      ...
      handler: async ({ id, is_default, provider_config, ...rest }) => {
    ...
    defineTool({
      ...
      handler: async ({ template_id, variables }) => {
    ...
    defineTool({
      ...
      handler: async ({ campaign_id, recipients, from_contacts }) => {
...
export function commsTriageTools(service: CommsService, db: import("@kernl/extension-sdk").SqliteDb, config: { openaiApiKey: string; anthropicApiKey: string; defaultProvider?: string }): ToolDefinition[] {
  return [
    defineTool({
      ...
      handler: async ({ comm_id, content, instruction }) => {
